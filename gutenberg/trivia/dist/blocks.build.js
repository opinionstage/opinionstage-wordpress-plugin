...
registerBlockType('opinion-stage/block-os-trivia', {
  ...
  keywords: [__('Opinion Stage Trivia Quiz'), __('Opinion Stage Trivia Quiz Insert')],
  attributes: {
    embedUrl: {
      source: 'attribute',
  ...
  edit: function edit(props) {
    ...
    if (osGutenData.isOsConnected == '') {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
        ...
        className: "os-trivia-wrapper components-placeholder"
        ...
        className: "components-heading"
      }, "Please connect WordPress to Opinion Stage to start adding trivia"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("button", {
      ...
      jQuery(document).ready(function ($) {
        ...
        jQuery('body').on('click', '[data-opinionstage-content-launch]', function (event) {
          ...
          setTimeout(function () {
            ...
            var text = $('#oswpLauncherContentPopuptrivia').attr('data-os-block');
      ...
      var contentViewEditStatOs = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
        ...
        id: "oswpLauncherContentPopuptrivia",
        className: "components-button is-button is-default is-block is-primary",
        "data-opinionstage-content-launch": true,
        "data-os-block": "trivia quiz",
        onClick: onSelectButtonClick
      }, "Select a Trivia Quiz"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("input", {
        type: "button",
        value: "Create a New Trivia Quiz",
        className: "components-button is-button is-default is-block is-primary",
      ...
      if (embedUrl != '' && embedUrl) {
        if (buttonText == 'Embed') {
          ...
          }, "Trivia Quiz: ", insertItemOsTitle))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("span", null));
        }
