                ...
                return (
                    <div className={ props.className }>
                        <div className="os-form-wrapper components-placeholder">
                            ...
                            <input id="owspLaunchInputCreate" type="button" data-opinionstage-content-launch value="Create a New Form" className="components-button is-button is-default is-block is-primary" />
                        </div>          
                    </div>
                );
            }else{                
