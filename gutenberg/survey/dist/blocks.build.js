...
registerBlockType('opinion-stage/block-os-survey', {
  ...
  keywords: [__('Opinion Stage Survey'), __('Opinion Stage Survey')],
  attributes: {
    embedUrl: {
      source: 'attribute',
  ...
  edit: function edit(props) {
    ...
    if (osGutenData.isOsConnected == '') {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
        ...
        className: "os-survey-wrapper components-placeholder"
        ...
        className: "components-heading"
      }, "Please connect WordPress to Opinion Stage to start adding surveys"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("button", {
      ...
      jQuery(document).ready(function ($) {
        ...
        jQuery('body').on('click', '[data-opinionstage-content-launch]', function (event) {
          ...
          setTimeout(function () {
            ...
            $('#oswpLauncherContentPopupsurvey').attr('data-os-block');
            var text = $('#oswpLauncherContentPopupsurvey').attr('data-os-block');
      ...
      var contentViewEditStatOs = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
        ...
        id: "oswpLauncherContentPopupsurvey",
        className: "components-button is-button is-default is-block is-primary",
        "data-opinionstage-content-launch": true,
        "data-os-block": "survey",
        onClick: onSelectButtonClick
      }, "Select a Survey"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("input", {
        type: "button",
      ...
      if (embedUrl != '' && embedUrl) {
        if (buttonText == 'Embed') {
          ...
          }, "Survey: ", insertItemOsTitle))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("span", null));
        }
