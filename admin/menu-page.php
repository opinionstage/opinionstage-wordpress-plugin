...
function opinionstage_register_menu_page() {
	if (function_exists('add_menu_page')) {
		...
		$os_client_logged_in = opinionstage_user_logged_in();
			...
			$menu_label_examples = '<span id="oswpLauncherContentPopupExamples" data-opinionstage-content-launch data-os-view="examples">Templates</span>';
			add_submenu_page(OPINIONSTAGE_MENU_SLUG, 'Templates', $menu_label_examples, 'edit_posts','opinionstage-view-my-items','opinionstage_load_template');
			...
			$menu_label_examples = '<span id="oswpLauncherContentPopupExamples" data-opinionstage-content-launch data-os-view="examples">Templates</span>';
			add_submenu_page(OPINIONSTAGE_GETTING_STARTED_SLUG, 'Templates', $menu_label_examples, 'edit_posts','opinionstage-view-my-items','opinionstage_load_template');
