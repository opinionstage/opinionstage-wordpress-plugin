<div class="opinionstage-hero-line">
    ...
    <?php if ( ! empty( $user_email ) ) { ?>
        <div class="opinionstage-connectivity-status">
            <a href="https://help.opinionstage.com/en/articles/2557183" class="opinionstage-hero-line__need-help" target="_blank"  rel="noopener">Need help?</a>
            ...
            <form method="POST" action="<?php echo esc_url( get_admin_url( null, 'admin.php?page=' . OPINIONSTAGE_DISCONNECT_PAGE ) ); ?>" class="opinionstage-disconnect-form">
                <?php wp_nonce_field( 'opinionstage_disconnect_nonce', 'opinionstage_nonce' ); ?>
