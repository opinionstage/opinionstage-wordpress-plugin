...
<form action="<?php echo esc_attr( OPINIONSTAGE_LOGIN_PATH ); ?>" method="get" class="opinionstage-connect-form">
    ...
    <a href="https://www.youtube.com/watch?v=nJeGqJcBzmg" target="_blank"  rel="noopener" class="opinionstage-button"><?php esc_html_e( 'View video', 'social-polls-by-opinionstage' ) ?></a>
	<div>
